...
class Contact extends Component {
  ...
  render() {
  	...
  	var arr2=["红蜜家","地址：北京市朝阳区百子湾路明日世界西侧20米","总机：4009609099"];
    return (
...
var HotyqDes=React.createClass({
	 render(){
	 		return <div>
			 				...
			 				<p>TEL：010-57799869－8121</p>
			 				<p>Mail：BD@hotyq.cn</p>
			 				<p className={style.title}>客服</p>
			 				<p>TEL：010-57799869－8131</p>
			 				<p>Mail：kf@hotyq.cn</p>
			 				<p>QQ：2284680653</p>
			 				<p className={style.title}>媒体账号</p>
			 				<a href="http://weibo.com/hotyq" className={style.weiboHref}  style={{backgroundImage:`url(${imgUrl}/hotFanWeiBo.jpg)`}}>红演圈微博</a>
			 				<a href="http://weibo.com/p/1005055958399021" className={style.weiboHref} style={{ backgroundImage:`url(${imgUrl}/hotFanWeiBo.jpg)`}}>红蜜家微博</a>
			 				<div className={style.erweima}>
			 					<img src={`${imgUrl}/hotFanWeiXin.jpg`} />
			 					<p className={style.erweides}>扫描二维码关注官方微信</p>
			 				</div>
	 				</div>
	 }
})
