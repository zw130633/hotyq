  ...
  render() {
    ...
    return (
      <div className={style.joinUs}>
      		...
      		<p className={style.txt}>加入我们，你会发现：这里没有森严的等级制度，<br/>只有一群能嗨、敢拼的年轻人相互学习一起成长；<br/>这里的每个人都会尽力燃烧自己的小宇宙，<br/>让我们的大集体变得更加不可思议。<br/>在这里，每天都经历着工作生活的丰富多彩，每天都在和小伙伴们一起实现新的突破！<br/>来吧，加入红演圈，我们一起成就.<br/>简历投递至：hr@hotyq.com</p>
      		<div className={style.workLink}>
      			<span>具体岗位要求请点击这里：</span>
      			<a href="https://hr.lagou.com/company/gongsi/47523.html" target='_blank'><img src={`${imgUrl}/joinus_7.jpg`} /></a>
      			<a href="http://company.zhaopin.com/CC208309383.htm" target='_blank'><img src={`${imgUrl}/joinus_8.jpg`} /></a>
      		</div>
      </div>
    )
  }
