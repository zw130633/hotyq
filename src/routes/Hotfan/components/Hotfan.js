   ...
   componentDidMount() {
        ...
        var mySwiper = new Swiper ('.swiper-container', {
			    ...
			    paginationBulletRender: function (index, className) {
			    	return '<span class="' + className + '" style="background:#858585; width:0.16rem; height:0.16rem; border:0.02rem solid #858585;"></span>';
				  },
  ...
  render: function() {
    return <div className={style.nav_contain}>
    				<div className={style.navDes}>
				    	...
				    	新媒红贩是红演圈和新媒诚品合资成立的，专注于版权交易的顾问公司。公司拥有高品质，高热度作品版权源头。一对一为投资人提供有料，并且合适投资人风格方向的版权作品。版权交易的主要流程为线上曝光，线下交易。线上对我们拥有版权作品进行展示；线下进行版权拍卖和严格的版权交易流程。
				    	</p>
    				</div>
